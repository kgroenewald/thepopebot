  ...
  try {
    ...
    if (headlessContainer) {
      try {
        ...
        // Emit status line
        const agent = headlessContainer.codingAgent || 'claude-code';
        const backendApi = headlessContainer.backendApi || 'anthropic';
        yield { type: 'text', text: `\n\nRuntime: headless | Agent: ${agent} | Backend: ${backendApi}\n\n` };
